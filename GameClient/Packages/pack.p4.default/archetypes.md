...
struct P4Default_EntityForMovementArchetype
{
    ...
    // Automatically added
    // ------ ------ ------ ------ ------ ------ ------ /.
    public NetworkEntity                networkEntity;  //< RW (Read-only in inspector)
                                                        //^ Added when the entity is instantied
    public ControllableEntity           controlEntity;  //< RW
                                                        //^ Added when the entity is instantied
    public DCharacterInformationData    charInfo;       //< Read-only
                                                        //^ Added when the entity is instantied as a playable entity
}
```