...
namespace P4.Core.Graphics
{
    public static class CGraphicalCatmullromSplineUtility
    {
        ...
        /*[MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void CalculateCatmullromSpline(NativeArray<float3> nodes, NativeArray<float3> m_fillerArray, int slices, float tension, bool loop = false)
        {
            CalculateCatmullromSpline(nodes, 0, nodes.Length, m_fillerArray, 0, m_fillerArray.Length, slices, tension);
        }*/

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void CalculateCatmullromSpline(NativeArray<float3> nodes, int nodesStart, int nodesEnd, NativeArray<float3> m_fillerArray, int fillerStart, int fillerEnd, int slices, float tension,
            bool loop = false)
        {
