...
namespace PataNext.Export.Desktop.Visual.Overlays
{
    ...
    public class ProgressNotification : Notification, IHasCompletionTarget
    {
        ...
        public ProgressNotification()
        {
            ...
            Content.Add(textDrawable = new TextFlowContainer(t => t.Font.With(size: 24))
            {
                Colour           = Colour4.Gray,
                AutoSizeAxes     = Axes.Y,
        ...
        private void load()
        {
            colourQueued    = Colour4.DarkGoldenrod;
            colourActive    = Colour4.Blue;
            colourCancelled = Colour4.Red;
        }
        ...
        private class ProgressBar : Container
        {
            ...
            private void load()
            {
                colourActive = Colour4.Aqua;
                Colour       = colourInactive = Colour4.Gray;
                Height       = 5;
            }
        }
    }
